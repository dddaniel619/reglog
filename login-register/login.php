        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="https://cdn.shopify.com/s/files/1/2332/2107/products/Angus-Beef-Burger-_24-x-200g_-Europ-Food-Canarias-1598207103.jpg?v=1630570852"
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <span class="h1 fw-bold mb-0" style="color: #FFC107">MeatHub</span>
                  </div>
